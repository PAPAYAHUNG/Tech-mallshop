...
function Cart({ cart, handleAddtoCart }) {
  ...
  return (
    <div
      style={{ width: 400 }}
      className="absolute rounded-2xl top-20 right-10  z-50 bg-gray-800 "
    >
      ...
      <div className=" text-right mr-10 text-2xl font-bold text-red-700">
